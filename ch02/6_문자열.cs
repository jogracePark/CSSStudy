...
namespace ch02
{
    internal class _6_문자열
    {
        static void Main(string[] args)
        {
            ...
            // 문자열 자르기
            Console.WriteLine("greeting 0~4 까지 문자열 : " + greeting.Substring(0, 4)); // substring(start, length) 시작점부터 길이만큼의 문자를 가져옴
            ...
            Console.WriteLine("r1 : " + r1.GetType());
            Console.WriteLine("r2 : " + r2.GetType());
            Console.WriteLine("r3 : " + r3.GetType());
        }
    }
}
